FILE(GLOB Convolution3D_Sources RELATIVE "${CMAKE_CURRENT_SOURCE_DIR}"
  "*.c"
  "*.cpp"
  "*.hpp"
  "*.h"
...
IF( MSVC OR MINGW )
    ...
    #  LIST(APPEND Convolution3D_Sources "Convolution3D64.def")
    # else()
    #  LIST(APPEND Convolution3D_Sources "Convolution3D.def")
    # endif() 
ENDIF()

IF( MSVC_IDE )
    # Ninja, unfortunately, seems to have some issues with using rc.exe
    LIST(APPEND Convolution3D_Sources "Convolution3D.rc")
ENDIF()
