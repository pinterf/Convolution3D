...
//
//
#define COMPUTE_FAST121(pl_pitch_p, nl_pitch_p, pl_pitch_c, nl_pitch_c, pl_pitch_n, nl_pitch_n,Label121,Label3D,TheEnd) __asm \
	{												\
		__asm mov ecx, w8							\
		__asm Label121:								\
		__asm movq mm4, [esi]						\
		...
		__asm psllw mm5, 1							\
													\
		__asm COMPUTE_MUL_PIXEL (eax,4)				\
		__asm add eax, 8							\
													\
		__asm COMPUTE_MUL_PIXEL (ebx,4)				\
		__asm add ebx, 8							\
													\
...
#define COMPUTE_FAST111(pl_pitch_p, nl_pitch_p, pl_pitch_c, nl_pitch_c, pl_pitch_n, nl_pitch_n, Label111,Label3D,TheEnd) __asm \
	{												\
		__asm mov ecx, w8							\
		__asm Label111:								\
		__asm movq mm4, [esi]						\
		...
		__asm psllw mm4, 1							\
		__asm psllw mm5, 1							\
		__asm paddw mm4, round_11					\
		__asm paddw mm5, round_11					\
		__asm pmulhuw mm4, multi_11					\
		__asm pmulhuw mm5, multi_11					\
		__asm packuswb mm4, mm5						\
		__asm movntq [edi], mm4						\
		__asm add edi, 8							\
		__asm dec ecx								\
